...
//
// BACKFILL: POST a JSON body {"startDate":"YYYY-MM-DD","endDate":"YYYY-MM-DD"} to
// rewrite a historical range as true-daily (used to fix old rolling-aggregate
// rows). With no body (the daily cron), it uses the default trailing windows.
// Run backfill in chunks (e.g. 30 days at a time) — see docs/SEO_DETECTORS_AND_BACKFILL.md.
//
